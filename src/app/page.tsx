      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          ...
          <Link href="/create" className="group">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center hover:bg-white/20 transition-all duration-300 border-2 border-white/20 hover:border-white/40">
              ...
              <div className="bg-gradient-to-r from-orange-400 to-red-500 text-white font-bold py-3 px-6 rounded-lg group-hover:from-orange-300 group-hover:to-red-400 transition-all">
                CREATE GAME
              </div>
            </div>
          </Link>
          ...
          <Link href="/join" className="group">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center hover:bg-white/20 transition-all duration-300 border-2 border-white/20 hover:border-white/40">
              ...
              <div className="bg-gradient-to-r from-blue-400 to-purple-500 text-white font-bold py-3 px-6 rounded-lg group-hover:from-blue-300 group-hover:to-purple-400 transition-all">
                JOIN GAME
              </div>
            </div>
          </Link>
